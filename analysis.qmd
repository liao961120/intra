...
article. The first model, which infers parameters from a single set of time
...
tree depth reached. From the inspection of the trace plots, the four chains
mix well for all fits[^trace]. We list the diagnostic summaries for the four fits
below:
